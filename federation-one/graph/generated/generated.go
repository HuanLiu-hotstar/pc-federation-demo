...
type ComplexityRoot struct {
	...
	Query struct {
		GetContent         func(childComplexity int, id string) int
...
type QueryResolver interface {
	GetContent(ctx context.Context, id string) (*model.Content, error)
}
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Query.GetContent":
		...
		return e.complexity.Query.GetContent(childComplexity, args["id"].(string)), true
...
func (ec *executionContext) _Entity_findContentByID(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNContent2ᚖfederationᚑoneᚋgraphᚋmodelᚐContent(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Query_GetContent(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Query().GetContent(rctx, args["id"].(string))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
	...
	res := resTmp.(*model.Content)
	fc.Result = res
	return ec.marshalOContent2ᚖfederationᚑoneᚋgraphᚋmodelᚐContent(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalNContent2federationᚑoneᚋgraphᚋmodelᚐContent(ctx context.Context, sel ast.SelectionSet, v model.Content) graphql.Marshaler {
	return ec._Content(ctx, sel, &v)
}

func (ec *executionContext) marshalNContent2ᚖfederationᚑoneᚋgraphᚋmodelᚐContent(ctx context.Context, sel ast.SelectionSet, v *model.Content) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "must not be null")
		}
...
func (ec *executionContext) marshalOContent2ᚖfederationᚑoneᚋgraphᚋmodelᚐContent(ctx context.Context, sel ast.SelectionSet, v *model.Content) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	return ec._Content(ctx, sel, v)
